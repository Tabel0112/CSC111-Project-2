...
class TestMainHelpers(unittest.TestCase):
    ...
    def test_choose_visible_country_codes_keeps_shocked_countries(self) -> None:
        ...
        wave_history = [
            {"step": 0, "shock_data": {"USA": 0.2}, "health_data": {}, "pressure_data": {}},
            {"step": 1, "shock_data": {"ATG": 0.1}, "health_data": {}, "pressure_data": {}},
        ]
    ...
    def test_prompt_for_runtime_options_accepts_defaults(self) -> None:
        ...
        self.assertEqual(prompted.steps, 18)
    ...
    def test_prompt_for_runtime_options_overrides_values(self) -> None:
        ...
        answers = iter(["0.01", "10", "80", "12", "trade", "y", "United States", "done", "0.25"])
        ...
        self.assertEqual(prompted.steps, 10)
