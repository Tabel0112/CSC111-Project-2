"""Macroeconomic Shock Simulator: Simulation

This module runs the repeated time-step disruption model, including pressure
propagation, substitution, inventory buffering, shortages, and health damage.
